...
As the intensity of the emissions is below ten percent of the continuum, we needed a good signal to noise ratio [SNR] and a very accurate continuum normalization.
...
\end{equation}
$2.3548$ is the the full width half maximum [FWHM] of the standard Gaussian. See \cite{SablowskiSchanne2018} p.\ 320 for an explanation how spectral resolution is defined.
